...
The outline of the paper is as follows. In Section 2, we present materials and methods of our research. In Section 3, we present the main results and their discussion. Our conclusions and future work are presented in Section 4.
...
\TODO{ LISTO  Revisar si la nueva redacción de este párrafo coincide con la
  ...
  {XXX} por las referencias correspondientes (Pablo, 1/5/16)}
...
\TODO{ EN REALIDAD ASÍ ES USADO EN EL TEXTO FUENTE
