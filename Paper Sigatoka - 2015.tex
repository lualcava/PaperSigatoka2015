...
\TODO{ CORREGIDO (LUIS-ALEX)
revisar si la nueva redacción de este párrafo coincide con la
  ...
  sistema en algo así son absolutamente necesarias.  Favor reemplazar
   por las referencias correspondientes (Pablo, 1/5/16)}

The early warning system developed by Ganry and Meyer \citep{ganry1972} and modified by Ganry and Laville \citep{ganry1983} to use for controlling yellow Sigatoka in Cameroon, later was adapted for Ternesien \citep{Ternesien1985} and Fouré \citep{foure1988} for the black Sigatoka.  

This bilogical warning system is based on weekly quantified observations of the disease progression on young leaves of the plant, according to
Fouré's scale of the symptom stages. The numeric coefficients describe the degree of incidence and the severity of the disease development.  These coefficients are used to
calculate two variables: gross sum and state of evolution.

\TODO{ EN REALIDAD ASÍ ES USADO EN EL TEXTO FUENTE EN INGLÉS (LUIS ALEX)
coefficients??  No suena como coeficientes (un factor que
...
%
The main contribution of this work is the selection of the best machine learning technique to forecast the black Sigatoka development rate according to the metric indicated below. 

The outline of the paper is as follows. In Section 2, we introduce the machine learning techniques used in this research and the main related works. In section 3, we present the data used and the methodology for the study results. In section 4, we present the results and their discussion. Our conclusions and future work are presented in Section 5.
