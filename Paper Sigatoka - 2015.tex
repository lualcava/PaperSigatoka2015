...
\marginnote{La bibliografia debe ser autor, año}
...
maturation \marginnote{maturation or ripening?} of bunches, which is
...
\marginnote{Esto es parte del ``related works''}
%
...
In this work, we compare five machine learning techniques (support
...
Morelet, is the main problem phytopathologic of banana and plantain
crops in Central America \citep{MarinVargas1995}.
...
formulated by \citep{Wei2013}: \marginnote{Falta completar la cita
  XXXXX con el libro de SVR}
...
\begin{figure}[h] 
 \centering
 \includegraphics[scale=.3]{Phase_one_Best_R2_for_each_algortihm}
...
\begin{figure}[h] 
 \centering
 \includegraphics[scale=.3]{Phase_one_Best_R2_for_each_number_of_observation_range_in_the_patterm}
 \caption{Phase one - Best $R^2$ for each algorithm} 
 \label{figura5} 
\end{figure}
...
\begin{figure}[h] 
 \centering
 \includegraphics[scale=.3]{Phase_one_Best_R2_for_variables}
 \caption{Phase one - Best $R^2$ for each variable combination} 
 \label{figura6} 
\end{figure}

\figurename $.$\ref{figura7} shows the pareto frontier with respect to $R^2$ and $RMSE$. Results are group by farm.

\begin{figure}[h] 
 \centering
 \includegraphics[scale=.6]{Phase_one_R2_RMSE}
...
\bibitem[Camargo et al.,2012]{Camargo2012} Camargo, A., Molina, J., Cadena-Torres, J., Jiménez, N., Kim, J. 2012. Intelligent systems for the assessment of crop disorders. Computers and Electronics in Agriculture(85), 1-7. doi:10.1016/j.compag.2012.02.017.
