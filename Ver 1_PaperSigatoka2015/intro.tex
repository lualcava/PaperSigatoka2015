...
using input variables such as: air temperature, relative humidity, solar radiation, precipitation and wind speed \review{LISTO - completar las variables de
  entrada usada} to predict the evolution stage in the biological warning system\review{LISTO - completar las variables de salida - Modificado}.
