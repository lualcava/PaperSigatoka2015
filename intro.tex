...
using input variables such as: air temperature, relative humidity, solar radiation, precipitation and wind speed \review{completar las variables de
  entrada usada - Modificado} to predict the evolution stage in the biological warning system\review{completar las variables de salida - Modificado}.
