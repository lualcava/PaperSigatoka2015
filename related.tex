...
\TODO{MODIFICADO - Falta indicar qué concluyen los dos surveys anteriores ------ como indico, en realidad ellos mencionan qué métodos han usado en los paper, pero no dan R2 o rmse, ni detallan resultados en general}
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Nota. la cita para lo de plant virus identificacion es  \citet{Glezakos2010}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
\todofn{variability}{variabilidad de qué? - MODIFICADO: de los datos de cada uno }  
%
...
\TODO{MODIFICADO - Importantísimo es explicar aquí brevemente por qué esos otros
