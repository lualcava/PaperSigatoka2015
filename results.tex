...
\end{table}
%
La \figref{figura4} muestra los box plots con respecto al RMSE para el resto de técnicas (excluída las ESN). Se aprecia que a excepción de las SVR with sigmoid kernel, las otras técnicas poseen compartamientos muy similares. Aunque el promedio del RMSE es diferente entre la Rica (cercano a 450)y 28 Millas (cercano a ñps820), la tendencia a preferir las mismas técnicas se mantiene en ambas fincas.
...
The Pareto frontier for the La Rita farm is composed by 96 elements. The \tablename $.$\ref{tabla3} shows the composition about variables and observation ranges.
